...
int main(int argc,char** argv){
 ...
 if (argc!=3)
 {
   ...
   exit(1); //fontos hogy ha hiba van, egyből 1-et dobjunk vissza, illetve error-ba írjuk hibát
  }
 int f,g;
 

 //NOTE: open sokkal alacsonyabb api mint az fopen
  //open nem annyira cross-platform
  //file descriptor-t adja vissza
    //note: linuxon minden file, pls stdout, beállítások
 f=open(argv[1],O_RDONLY); 
 //there is an access function with which we can see whether the file is exist or not
 ...
 char c;
 //meg kell adni hogy mennyit olvasson
 // * helyett &: cím helyett memória területet adjon vissza...?
