...
[("3D View",
  ...
  {"items":
   [("wm.call_panel",
    ...
    ("view3d.toggle_shading", {"type": 'Z', "value": 'PRESS', "shift": True}, None),
    ],
   },
  ),
 ("3D View Generic",
