...
int main( int argc, char* args[] )
{
	...
	// duplapufferelés (backbufferbe írjuk ki az adatokat, majd megcseréljük a kettőt amikor rajzolunk)
    ...
    win = SDL_CreateWindow( "Hello SDL&OpenGL!",		// az ablak fejléce
							...
							//OPENG-el tudjunk rá rajzolni			átmérezhető legyen
	...
	if ( error != GLEW_OK )
	{
		std::cout << "[GLEW] Error during the initialization of glew:" << error << std::endl;
		return 1;
	}
	...
	//////////////////////////////////////////////////////////////////////
	//
	// 3. lépés: indítsuk el a fő üzenetfeldolgozó ciklust
	// 
