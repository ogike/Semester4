...
void main()
{
	...
	//három dimenziós vektorral mintavételezzük a textúrát (cubemap)
		//ezt a vektor egy irányvektorként használjuk
		// (belül előszür megtalálja a metsző lapot, utána meg 2D mintavételezés)
