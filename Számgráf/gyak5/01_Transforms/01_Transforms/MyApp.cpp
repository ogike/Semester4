...
bool CMyApp::Init()
{
	...
	Vertex D = { glm::vec3(-1, 0, 1), glm::vec3(1, 1, 0) };
	Vertex E = { glm::vec3(0, sqrtf(2), 0),  glm::vec3(0, 1, 1)};
...
void CMyApp::Update()
{
	// nézeti (world -> cam) transzformáció beállítása
	//	lookAt kiszámolja az új bázisokat a meglévő pozició + két irányból
	m_matView = glm::lookAt(glm::vec3( 0,  0,  5),		// honnan nézzük a színteret	   - eye
...
void CMyApp::Render()
{
	...
	*/
	...
	// majd küldjük át a megfelelő 4x4f mátrixokat!
	//	Matrix4fv-ben v: nem külön külön adjuk meg a 16 floatot, hanem tömbként
	...
	glUniformMatrix4fv( m_loc_world,// erre a helyre töltsünk át adatot
						...
						GL_FALSE,	// NEM transzponálva (ha kéne, másolásnál sokkal kevesebb költség)
...
void CMyApp::Resize(int _w, int _h)
{
	...
	m_matProj = glm::perspective(   glm::radians(60.0f),	// 60 fokos nyílásszög radiánban
									...
									0.01f,					// közeli vágósík (csonka gúla közelebbi oldala)
									100.0f);				// távoli vágósík (csonka gúla távolabbi oldala)
}